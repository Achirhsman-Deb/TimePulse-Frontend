...
import { FaList, FaProductHunt, FaEdit, FaClipboardList, FaUsers } from 'react-icons/fa';
import { AiOutlineStock } from 'react-icons/ai';

const AdminDashboard_Component = () => {
    const navigate = useNavigate();

    const menuItems = [
        { name: 'Overview', icon: <AiOutlineStock />, route: 'Overview' },
        { name: 'Create Category', icon: <FaList />, route: 'CreateCatagory' },
        { name: 'Create Product', icon: <FaProductHunt />, route: 'CreateProduct' },
        { name: 'Edit Product', icon: <FaEdit />, route: 'Products' },
        { name: 'Orders', icon: <FaClipboardList />, route: 'Orders' },
        { name: 'UI', icon: <FaUsers />, route: 'Users' },
    ];
...
export default AdminDashboard_Component;
